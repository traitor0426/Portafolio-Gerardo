...
CREATE TABLE `telefonoproveedores` (
  ...
  KEY `Fk_TeleProveedor` (`CodigoProveedor`),
  CONSTRAINT `Fk_TeleProveedor` FOREIGN KEY (`CodigoProveedor`) REFERENCES `proveedores` (`CodigoProveedor`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `telefonoproveedores` VALUES ('pv-002','2560991238'),('pv-003','2560991238'),('pv-004','2560991238'),('pv-005','2560991238'),('pv-006','2560991238'),('pv-007','2560991238'),('pv-008','2560991238'),('pv-009','2560991238'),('pv-010','2560991238');
